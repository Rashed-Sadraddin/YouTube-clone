                ...
                <NavLink to={`/one/${props.id}`}>
                  <div className="hover:relative group  hover:bg-neutral-800 mx-2 my-6 h-[240px] w-[270px]  hover:duration-[0.5s] hover:delay-[1s]  overflow-hidden">
                    ...
                    <div className=" group-hover:pr-2 group-hover:pl-2 group-hover:delay-[1s] group-hover:duration-[0.5s] flex  text-white">
                      <img
                        className="float-left w-10 h-10 rounded-full mr-3"
                        src={props.pagepic}
                      ></img>
                      <div className="float-left w-[70%] ">
                        <h4 className="text-white w-[166px] h-5 overflow-hidden float-left">
                          {props.title}{" "}
                        </h4>
                        <p className="text-neutral-400 mb-0">
                          {props.pagename} <CheckCircleFilled className="" />
                        </p>
                        <span className="text-neutral-400">
                          {props.view} views . {props.time} ago
                        </span>
                      </div>
                      <div className="">
                        <button>
                          <EllipsisOutlined
                            rotate={90}
                            className=" text-lg h-4 w-4 float-right"
                          />
                        </button>
                      </div>
                    </div>
